...
namespace Agap.UnitTest.Services
{
    [TestClass]
    public class ApiServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            _configurationMock.Setup(c => c["CoutriesAPI:urlBase"]).Returns("http://localhost/");
            _configurationMock.Setup(c => c["CoutriesAPI:tokenName"]).Returns("Authorization");
            _configurationMock.Setup(c => c["CoutriesAPI:tokenValue"]).Returns("Bearer token");
