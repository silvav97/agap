...
namespace Agap.UnitTest.Repositories
{
    ...
    public class GenericRepositoryTests
    {
        ...
        private GenericRepository<Fertilizer> _repository = null!;
        ...
        public void Initialize()
        {
            ...
            _repository = new GenericRepository<Fertilizer>(_context);
        }
        ...
        {
            // Arrange
            var testEntity = new Fertilizer { Name = "Test", Brand = "Brand" };
        ...
        public async Task AddAsync_GeneralExceptionThrown_ReturnsError()
        {
            ...
            var repository = new GenericRepository<Fertilizer>(exceptionalContext);
            var testEntity = new Fertilizer { Name = "Test" };
        ...
        public async Task DeleteAsync_ShouldDeleteEntity()
        {
            // Arrange
            var testEntity = new Fertilizer { Name = "Test", Brand = "Brand" };
            await _context.Set<Fertilizer>().AddAsync(testEntity);
        ...
        {
            // Arrange
            await _context.Set<Fertilizer>().AddRangeAsync(new List<Fertilizer>
        {

            new Fertilizer { Name = "Test1", Brand = "Brand1" },
            new Fertilizer { Name = "Test2",  Brand = "Brand2" },
            new Fertilizer { Name = "Test3",  Brand = "Brand3" },
        });
            await _context.SaveChangesAsync();
        ...
        public async Task UpdateAsync_GeneralExceptionThrown_ReturnsError()
        {
            ...
            var exceptionalContext = new ExceptionalDataContext(_options);
            var testEntity = new Fertilizer { Name = "Test", Brand = "Brand" };
            await exceptionalContext.Set<Fertilizer>().AddAsync(testEntity);
